...
export const FORK_ONLY_PATHS = new Set([
  '.github/workflows/horca_ci.yml',
  '.github/workflows/horca_maintenance.yml',
  ...
  'config/linux/after-install-horca.sh',
  'config/linux/after-remove-horca.sh',
  'config/scripts/disable-upstream-workflows.sh',
  'config/scripts/herdr-import-architecture.test.ts',
  'config/horca-carried-patches.json',
  'resources/linux/bin/horca',
  'src/main/providers/terminal-backend-composition.ts',
  'src/main/providers/terminal-backend-composition.test.ts',
  ...
  'config/scripts/horca-sync-main.sh',
