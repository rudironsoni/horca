...
describe('fork upstream overlay guard', () => {
  ...
  it('lists in-repo Horca release files as fork-only', () => {
    ...
    expect(FORK_ONLY_PATHS.has('.github/workflows/horca_ci.yml')).toBe(true)
    expect(FORK_ONLY_PATHS.has('.github/workflows/horca_maintenance.yml')).toBe(true)
    expect(FORK_ONLY_PATHS.has('src/main/providers/terminal-backend-composition.ts')).toBe(true)
  })
