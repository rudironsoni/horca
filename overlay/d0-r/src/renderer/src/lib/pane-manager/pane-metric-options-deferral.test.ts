...
function makePane(): ManagedPane {
  return registerMockXtermPaneState({ id: 1, terminal: { options: {} } }) as unknown as ManagedPane
}
...
function makeInternalPane(): ManagedPaneInternal {
  return registerMockXtermPaneState({ id: 1, terminal: { options: {} } }) as unknown as ManagedPaneInternal
}
