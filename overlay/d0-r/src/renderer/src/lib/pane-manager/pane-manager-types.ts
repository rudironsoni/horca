import type { IDisposable } from '../../../../shared/orca-terminal-surface'
...
export type PaneManagerOptions = {
  ...
  terminalOptions?: (paneId: number) => Record<string, unknown>
...
export type ScrollState = {
  ...
  viewportY: number
  baseY: number
  firstVisibleLineMarker?: { dispose: () => void; isDisposed: boolean; line: number }
  firstVisibleLogicalLineMarker?: { dispose: () => void; isDisposed: boolean; line: number }
