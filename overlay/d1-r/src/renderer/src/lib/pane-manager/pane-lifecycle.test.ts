...
describe.skip('attachWebgl', () => {
  ...
  it('keeps a pane on the DOM renderer after WebGL context loss', () => {
    ...
    expect(pane.terminal.fit).toHaveBeenCalledTimes(1)
  ...
  it('keeps auto-mode panes on WebGL after complex-script output', () => {
    ...
    expect(pane.terminal.fit).not.toHaveBeenCalled()
...
describe.skip('openTerminal — addon and provider wiring', () => {
  beforeEach(() => {
