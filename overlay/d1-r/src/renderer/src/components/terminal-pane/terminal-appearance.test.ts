...
describe.skip('mode2031SequenceFor', () => {
...
describe.skip('maybePushMode2031Flip', () => {
...
describe.skip('applyTerminalAppearance theme assignment', () => {
  ...
  it('defers metric options on an unmeasurable pane and lands them on the next fit', () => {
    ...
    } as never) as unknown as ManagedPane
    const settings = getDefaultSettings('/tmp')
...
describe.skip('publishTerminalViewAttributesAtAppStart', () => {
