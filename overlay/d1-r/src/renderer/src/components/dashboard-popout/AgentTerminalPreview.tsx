...
import { GhosttyPaneTerminal } from '@/lib/pane-manager/ghostty-renderer/ghostty-pane-terminal'
...
export function AgentTerminalPreview({
  ...
  const terminalRef = useRef<GhosttyPaneTerminal | null>(null)
  ...
  useEffect(() => {
    ...
    let disposed = false
    let terminal: GhosttyPaneTerminal | null = null
    ...
    const replayConnection = (
      ...
      if (!terminal) {
        const previewOpts = buildPreviewTerminalOptions({
        ...
        terminal = new GhosttyPaneTerminal({
          measureRoot: container,
          appearance: {
            fontSize: previewOpts.fontSize,
            fontFamily: previewOpts.fontFamily,
            fontWeight: previewOpts.fontWeight,
            fontWeightBold: previewOpts.fontWeightBold,
            lineHeight: previewOpts.lineHeight,
            cursorBlink: previewOpts.cursorBlink,
            cursorStyle: previewOpts.cursorStyle,
            cursorInactiveStyle: previewOpts.cursorInactiveStyle,
            scrollback: previewOpts.scrollback,
            theme: previewOpts.theme,
            minimumContrastRatio: previewOpts.minimumContrastRatio,
            allowTransparency: previewOpts.allowTransparency,
            scrollSensitivity: previewOpts.scrollSensitivity,
            fastScrollSensitivity: previewOpts.fastScrollSensitivity,
            macOptionIsMeta: previewOpts.macOptionIsMeta
          }
        })
        try {
