...
// Why: terminal's WriteBuffer._innerWrite invokes write-completion callbacks with
...
// (Discord #performance / issue #2836). Verified against the vendored terminal
// 6.1.0-beta.287 in terminal-write-buffer-stall.repro.test.ts.
 ...
 * escape into terminal's WriteBuffer. Steps are guarded individually so an
