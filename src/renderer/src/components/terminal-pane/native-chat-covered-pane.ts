...
/**
 * Leaf container selector that excludes panes whose terminal sits under the native
 * chat portal. Chat mode is a tab flag, but only the chat leaf's terminal is
