...
// Why: terminal's EscapeSequenceParser invokes custom CSI/OSC handlers
...
// Verified against vendored terminal 6.1.0-beta.287 in
// terminal-write-buffer-stall.repro.test.ts. Same escape class as
 ...
 * degraded to "not handled" (terminal falls through to the previous/default
