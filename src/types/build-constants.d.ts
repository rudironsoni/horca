...
// electron-vite defaults to 'horca' so local `pnpm build` / `pnpm dev` use
// ~/.horca. Set ORCA_DOWNSTREAM_BUILD=0 to compile 'official'. Vitest skips
// the define pass; the runtime accessor falls back to a globalThis override,
// then 'official'.
