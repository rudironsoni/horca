...
Horca currently publishes an unsigned Windows installer. The release workflow checks this state so it cannot accidentally ship with Stably's publisher identity.
